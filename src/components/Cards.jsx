  ...
  return (
    <div className='w-full h-screen bg-zinc-900 flex items-center px-32 gap-5'>
        ...
        <div className='card relative flex items-center justify-center  rounded-xl w-full h-full bg-[#004D43] '>
           <img className='w-32 justify-center' src="
        ...
        <img className='w-32' src="
           ...
           " alt="" />
           <button className='absolute px-5 py-1 rounded-full border-2 left-10 bottom-10'>&copy;RATING5ONCLUTCH</button></div>
        <div className='card relative flex items-center justify-center  rounded-xl w-1/2 h-full bg-[#004D43]'>
        <img className='w-32 justify-center' src="
           https://ochi.design/wp-content/uploads/2022/04/logo003.png
           " alt="" />
           <button className='absolute px-5 py-1 rounded-full border-2 left-10 bottom-10'>&copy;BUSINESSBOOTCAMP</button></div>
