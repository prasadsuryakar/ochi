...
const Footer = () => {
   return (
    <div className=' flex gap-5 w-full h-screen bg-zinc-900 p-20'>
        ...
        <h1 className='text-[8vw] font-semibold uppercase leading-none tracking-tighter -mb-15'>Eye-</h1>
        <h1 className='text-[8vw] font-semibold uppercase leading-none tracking-tighter -mb-15'>Opening</h1>
        </div>
        ...
        <h1 className='text-[5vw] font-semibold uppercase leading-none -mb-10'>
            ...
            <div className='py-5'>
           <div className='hover:underline'> L:</div>
           <div className='hover:underline'> 202-1965 W 4th Ave</div>
           <div className='hover:underline'>Vancouver, Canada</div>
         </div>
         <div className='py-15'>
         <div className='hover:underline'>30 Chukarina St</div>
           <div className='hover:underline'>Lviv, Ukraine</div>
           <div className='hover:underline'>E:</div>
           <div className='hover:underline textsize- '>hello@ochi.design</div>
